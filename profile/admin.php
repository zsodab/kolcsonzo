...
<div class="profile-container">
    <div class="tabs">
        <button class="tab-link active" data-target="bookings">Felhasználók</button>
        <button class="tab-link" data-target="conversations">Kereskedések</button>
        <button class="tab-link" data-target="reviews">Foglalások</button>
        <button class="tab-link" data-target="profile">Egyéb</button>
    </div>
